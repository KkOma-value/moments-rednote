...
// ==========================================
export const WeChatPreview: React.FC<RendererProps> = ({ data }) => {
            ...
            <div className="h-12 bg-[#EDEDED] flex items-center justify-between px-5 text-xs font-semibold shrink-0">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="w-6 h-3 bg-gray-900 rounded-sm ml-1 relative">
                        <div className="absolute right-0 top-0 bottom-0 w-0.5 bg-gray-300 rounded-r-sm"></div>
                    </div>
                </div>
            </div>
...
// RedNote Preview
// ==========================================
export const RedNotePreview: React.FC<RendererProps> = ({ data }) => {
    const currentDate = new Date();
